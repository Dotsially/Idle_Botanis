...
/*
static glfLoadAttribute(cgltf_accessor accesor, int numComp, int dataType, void *dstPtr)
{
    int n = 0;
    void *buffer = (dataType *)accesor->buffer_view->buffer->data + accesor->buffer_view->offset/sizeof(dataType) + accesor->offset/sizeof(dataType);
